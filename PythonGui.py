...
class videoGUI:
    ...
    def __init__(self, window, window_title):
        ...
        filemenu.add_command(label="New", command="do nothing")
        filemenu.add_command(label="Open", command="do nothing")
        filemenu.add_command(label="Save", command="do nothing")
        ...
        self.btn_stop = Button(bottom_frame, text="Stop", width=15, command=self.stop_video)
